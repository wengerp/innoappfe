		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#chnovobcsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chnovobcsapui5-display": {
								"semanticObject": "chnovobcsapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ch.novobc.sapui5",
									"url": sap.ui.require.toUrl("ch/novobc/sapui5")
								}
							}
						}
					}
